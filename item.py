...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"Raw_resume.csv") # reading the csv file
...
select = ['Peoplesoft','Internship','SQL Developer','React JS','workday']
...
elif option == 'React JS':
    st.table(file_type[file_type['Predicted Profile'] == 'React JS'])
elif option == 'workday':
